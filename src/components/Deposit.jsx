      ...
      {loading ? (
        ...
        <>
          ...
          <div className="px-3   bg-gray-800 rounded-lg shadow-lg">
            ...
            {isOpen && (
              <table className=" bg-white min-w-full  shadow-lg rounded-lg overflow-hidden">
                <thead>
                  <tr className="bg-gray-700 text-gray-300 text-left">
                    <th className="py-3 px-6 font-semibold">Machine ID</th>
                    <th className="py-3 px-6 font-semibold">Interest Amount</th>
                ...
                <tbody>
                  {interestData.map((row, index) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-6 text-gray-700">${row.amount}</td>
                      <td className="py-3 px-6 text-gray-700">{row.date}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
